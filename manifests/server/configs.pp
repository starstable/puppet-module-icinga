...
class icinga::server::configs (
  ...
  $f_idomodcfg                = $::icinga::server::file_idomodcfg,
  $f_ido2dbcfg                = $::icinga::server::file_ido2dbcfg,
  ...
  $instance_name                                         = $::icinga::server::instance_name,
  $output_type                                           = $::icinga::server::output_type,
  $output                                                = $::icinga::server::output,
  $ido_tcp_port                                          = $::icinga::server::ido_tcp_port,
  $ido_use_ssl                                           = $::icinga::server::ido_use_ssl,
  $output_buffer_items                                   = $::icinga::server::output_buffer_items,
  $output_buffer_file                                    = $::icinga::server::output_buffer_file,
  $file_rotation_interval                                = $::icinga::server::file_rotation_interval,
  $file_rotation_command                                 = $::icinga::server::file_rotation_command,
  $file_rotation_timeout                                 = $::icinga::server::file_rotation_timeout,
  $reconnect_interval                                    = $::icinga::server::reconnect_interval,
  $reconnect_warning_interval                            = $::icinga::server::reconnect_warning_interval,
  $data_processing_options                               = $::icinga::server::data_processing_options,
  $config_output_options                                 = $::icinga::server::config_output_options,
  $dump_customvar_status                                 = $::icinga::server::dump_customvar_status,
  $ido_debug_level                                       = $::icinga::server::ido_debug_level,
  $ido_debug_verbosity                                   = $::icinga::server::ido_debug_verbosity,
  $ido_debug_file                                        = $::icinga::server::ido_debug_file,
  $ido_max_debug_file                                    = $::icinga::server::ido_max_debug_file,

  $db_lock_file						 = $::icinga::server::db_lock_file,
  $ido2db_user     					 = $::icinga::server::ido2db_user,
  $ido2db_group     					 = $::icinga::server::ido2db_group,
  $socket_type     					 = $::icinga::server::socket_type,
  $socket_name     					 = $::icinga::server::socket_name,
  $socket_perm     					 = $::icinga::server::socket_perm,
  $ido2db_tcp_port     					 = $::icinga::server::ido2db_tcp_port,
  $ido2db_use_ssl     					 = $::icinga::server::ido2db_use_ssl,
  $db_servertype     					 = $::icinga::server::db_servertype,
  $db_host     						 = $::icinga::server::db_host,
  $db_port     						 = $::icinga::server::db_port,
  $db_socket     					 = $::icinga::server::db_socket,
  $db_name     						 = $::icinga::server::db_name,
  $db_prefix     					 = $::icinga::server::db_prefix,
  $db_user     						 = $::icinga::server::db_user,
  $db_pass     						 = $::icinga::server::db_pass,
  $max_systemcommands_age     				 = $::icinga::server::max_systemcommands_age,
  $max_servicechecks_age     				 = $::icinga::server::max_servicechecks_age,
  $max_hostchecks_age     				 = $::icinga::server::max_hostchecks_age,
  $max_eventhandlers_age     				 = $::icinga::server::max_eventhandlers_age,
  $max_externalcommands_age     			 = $::icinga::server::max_externalcommands_age,
  $max_logentries_age     				 = $::icinga::server::max_logentries_age,
  $max_acknowledgements_age     			 = $::icinga::server::max_acknowledgements_age,
  $max_notifications_age     				 = $::icinga::server::max_notifications_age,
  $max_contactnotifications_age     			 = $::icinga::server::max_contactnotifications_age,
  $max_contactnotificationmethods_age     		 = $::icinga::server::max_contactnotificationmethods_age,
  $max_downtimehistory_age     				 = $::icinga::server::max_downtimehistory_age,
  $trim_db_interval     				 = $::icinga::server::trim_db_interval,
  $housekeeping_thread_startup_delay     		 = $::icinga::server::housekeeping_thread_startup_delay,
  $ido2db_debug_level     				 = $::icinga::server::ido2db_debug_level,
  $ido2db_debug_verbosity     				 = $::icinga::server::ido2db_debug_verbosity,
  $ido2db_debug_file     				 = $::icinga::server::ido2db_debug_file,
  $ido2db_max_debug_file_size     			 = $::icinga::server::ido2db_max_debug_file_size,
  $debug_readable_timestamp     			 = $::icinga::server::debug_readable_timestamp,
  $oci_errors_to_syslog     				 = $::icinga::server::oci_errors_to_syslog,
  $oracle_trace_level     				 = $::icinga::server::oracle_trace_level,
) {
  ...
  file { $f_idomodcfg:
    ...
    owner   => root,
    group   => root,
    content => template('icinga/server/idomod.cfg.erb'),
  }
  ...
  file { $f_ido2dbcfg:
    ...
    owner   => root,
    group   => root,
    content => template('icinga/server/ido2db.cfg.erb'),
    notify  => Class['icinga::server::services'],
  }
