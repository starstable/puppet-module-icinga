...
class icinga::server (
  ...
  $file_idomodcfg           = $::icinga::server::params::file_idomodcfg,
  $file_ido2dbcfg           = $::icinga::server::params::file_ido2dbcfg,
  ...
  $instance_name                                         = $::icinga::server::params::instance_name,
  $output_type                                           = $::icinga::server::params::output_type,
  $output                                                = $::icinga::server::params::output,
  $ido_tcp_port                                          = $::icinga::server::params::ido_tcp_port,
  $ido_use_ssl                                           = $::icinga::server::params::ido_use_ssl,
  $output_buffer_items                                   = $::icinga::server::params::output_buffer_items,
  $output_buffer_file                                    = $::icinga::server::params::output_buffer_file,
  $file_rotation_interval                                = $::icinga::server::params::file_rotation_interval,
  $file_rotation_command                                 = $::icinga::server::params::file_rotation_command,
  $file_rotation_timeout                                 = $::icinga::server::params::file_rotation_timeout,
  $reconnect_interval                                    = $::icinga::server::params::reconnect_interval,
  $reconnect_warning_interval                            = $::icinga::server::params::reconnect_warning_interval,
  $data_processing_options                               = $::icinga::server::params::data_processing_options,
  $config_output_options                                 = $::icinga::server::params::config_output_options,
  $dump_customvar_status                                 = $::icinga::server::params::dump_customvar_status,
  $ido_debug_level                                       = $::icinga::server::params::ido_debug_level,
  $ido_debug_verbosity                                   = $::icinga::server::params::ido_debug_verbosity,
  $ido_debug_file                                        = $::icinga::server::params::ido_debug_file,
  $ido_max_debug_file                                    = $::icinga::server::params::ido_max_debug_file,

  $db_lock_file     = $::icinga::server::params::db_lock_file,
  $ido2db_user     = $::icinga::server::params::ido2db_user,
  $ido2db_group     = $::icinga::server::params::ido2db_group,
  $socket_type     = $::icinga::server::params::socket_type,
  $socket_name     = $::icinga::server::params::socket_name,
  $socket_perm     = $::icinga::server::params::socket_perm,
  $ido2db_tcp_port     = $::icinga::server::params::ido2db_tcp_port,
  $ido2db_use_ssl     = $::icinga::server::params::ido2db_use_ssl,
  $db_servertype     = $::icinga::server::params::db_servertype,
  $db_host     = $::icinga::server::params::db_host,
  $db_port     = $::icinga::server::params::db_port,
  $db_socket     = $::icinga::server::params::db_socket,
  $db_name     = $::icinga::server::params::db_name,
  $db_prefix     = $::icinga::server::params::db_prefix,
  $db_user     = $::icinga::server::params::db_user,
  $db_pass     = $::icinga::server::params::db_pass,
  $max_systemcommands_age     = $::icinga::server::params::max_systemcommands_age,
  $max_servicechecks_age     = $::icinga::server::params::max_servicechecks_age,
  $max_hostchecks_age     = $::icinga::server::params::max_hostchecks_age,
  $max_eventhandlers_age     = $::icinga::server::params::max_eventhandlers_age,
  $max_externalcommands_age     = $::icinga::server::params::max_externalcommands_age,
  $max_logentries_age     = $::icinga::server::params::max_logentries_age,
  $max_acknowledgements_age     = $::icinga::server::params::max_acknowledgements_age,
  $max_notifications_age     = $::icinga::server::params::max_notifications_age,
  $max_contactnotifications_age     = $::icinga::server::params::max_contactnotifications_age,
  $max_contactnotificationmethods_age     = $::icinga::server::params::max_contactnotificationmethods_age,
  $max_downtimehistory_age     = $::icinga::server::params::max_downtimehistory_age,
  $trim_db_interval     = $::icinga::server::params::trim_db_interval,
  $housekeeping_thread_startup_delay     = $::icinga::server::params::housekeeping_thread_startup_delay,
  $ido2db_debug_level     = $::icinga::server::params::ido2db_debug_level,
  $ido2db_debug_verbosity     = $::icinga::server::params::ido2db_debug_verbosity,
  $ido2db_debug_file     = $::icinga::server::params::ido2db_debug_file,
  $ido2db_max_debug_file_size     = $::icinga::server::params::ido2db_max_debug_file_size,
  $debug_readable_timestamp     = $::icinga::server::params::debug_readable_timestamp,
  $oci_errors_to_syslog     = $::icinga::server::params::oci_errors_to_syslog,
  $oracle_trace_level     = $::icinga::server::params::oracle_trace_level,
